@echo off
chcp 65001 >nul
title MinerU-OCR_webui.py 专用启动器
color 0B
:: 设置路径（请根据实际情况确认）

set "BASE_DIR=%~dp0"
set "LLAMA_SERVER=%BASE_DIR%llama\llama-server.exe"
set "MODEL=%BASE_DIR%models\MinerU2.5-Pro\MinerU2.5-Pro-2605-1.2B-Q4_K_M.gguf"
set "MMPROJ=%BASE_DIR%models\MinerU2.5-Pro\mmproj-MinerU2.5-Pro-2605-1.2B-f16.gguf"
set "PYTHON=%BASE_DIR%python_embeded\python.exe"
set "WEBUI=%BASE_DIR%core\MinerU-OCR_webui.py"
...
echo ============================================
echo   MinerU-OCR 专用启动器
echo   模型: MinerU2.5-Pro-2605-1.2B-Q4_K_M.gguf
echo   mmproj: mmproj-MinerU2.5-Pro-2605-1.2B-f16.gguf
echo   端口: 50600
echo ============================================
